...
def classify_videos ():
    ...
    for video_data_path in video_observation_list:
        ...
        if(bezOsob/liczbaUjec>0.9):
            ...
            statisticList[video_data_path[26:-4]]=( zNowymiOsobami/(ZeStarymiOsobami+zNowymiOsobami), bezOsob / (ZeStarymiOsobami + zNowymiOsobami))
            ...
            elif (ZeStarymiOsobami / (ZeStarymiOsobami + zNowymiOsobami)) >= 0.8 and dwaUjecia+jednoUjecie/(dwaUjecia+jednoUjecie+trzyLubWiecej)>0.4:
                classification_results[video_data_path] = "class_2"
                countC = countC + 1
    ...
    print(" countA " + str(countA) + " countB " + str(countB) +" countC " + str(countC )+ " countD " + str(countD)+" countE " + str(countE )+ " countF " + str(countF))
